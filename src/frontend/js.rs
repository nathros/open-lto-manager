...
extern "C" {
    ...
    fn downloadFile(url: &str, method: &str, contentType: &str, body: &str); // Defined in assets/js/common.js
}
...
pub fn js_download_file(url: &str, body: Value) {
    downloadFile(url, "POST", "application/json", body.to_string().as_str());
}
